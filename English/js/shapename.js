...
function check2(){
    a = document.getElementById("tb2").value
    console.log(a);
    if (a == "Hexagon"){
...
function check3(){
    a = document.getElementById("tb3").value
    console.log(a);
    if (a == "Octagon"){
...
function check4(){
    a = document.getElementById("tb4").value
    console.log(a);
    if (a == "Oval"){
...
function check5(){
    a = document.getElementById("tb5").value
    console.log(a);
    if (a == "Pentagon"){
...
function check6(){
    a = document.getElementById("tb6").value
    console.log(a);
    if (a == "Rectangle"){
...
function check7(){
    a = document.getElementById("tb7").value
    console.log(a);
    if (a == "Square"){
...
function check8(){
    a = document.getElementById("tb8").value
    console.log(a);
    if (a == "Triangle"){
